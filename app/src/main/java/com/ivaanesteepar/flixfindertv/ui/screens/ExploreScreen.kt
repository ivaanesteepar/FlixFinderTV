...
import com.ivaanesteepar.flixfindertv.room.entities.*
...
import com.ivaanesteepar.flixfindertv.ui.viewmodels.SeriesViewModel
import com.ivaanesteepar.flixfindertv.utils.BottomNavigationBar
import com.ivaanesteepar.flixfindertv.utils.ContentListSearch
            ...
            Box(
                ...
                Column(
                    ...
                    if (searchQuery.isNotEmpty()) {
                        ...
                        val listStateTab =
                            if (selectedTab == "Movies") movieTabListState else seriesTabListState
                        LazyColumn(
                            state = listStateTab,
                            modifier = Modifier
                                .fillMaxSize()
                            ...
                            val isLoadingExplore =
                                movies.isEmpty() && peliculasPopularesOffline.isEmpty()
