...
class UsersViewModelTest {
    ...
    fun tearDown() {
        ...
        clearAllMocks()
        unmockkAll()  // Limpia todos los mocks
        unmockkStatic(Toast::class)  // Limpia los mocks estáticos si los usaste
    }
...
//
//        // Configurar comportamiento del documento con el tipo explícito
//        val currentMoviesList: List<Map<String, Any>> = List(19) { // 19 movies in favorites (less than 20)
//            mapOf(
//                "id" to "movieId$it",
//                "title" to "Movie $it",
...
//            val listener = arg<(DocumentSnapshot?) -> Unit>(0)
//            listener.invoke(mockDocument)
//            mockTask
//        }
...
//                    assert(list.size == 20)
//                    assert(list.any { it["id"] == "movieId20" })
//                }
//            )
//        }
//    }
...
//
//        // 2. Crear mock con comportamiento estricto (no relaxed)
//        val movieDao = mockk<MovieDao>()
//
//        // 3. Configurar comportamiento esperado ANTES de la ejecución
//        coEvery { movieDao.insertFavorito(any()) } just Runs
//
//        // 4. Crear repositorio con el mock
//        val movieRepository = MovieRepository(movieDao)
//
//        // 5. Ejecutar el método bajo prueba
//        println("Ejecutando insertFavorito con: $favorito")
//        movieRepository.insertFavorito(favorito)
//
//        // 6. Verificar la interacción
//        println("Verificando llamada a insertFavorito...")
//        coVerify(exactly = 1) {
//            movieDao.insertFavorito(
//                withArg { inserted ->
//                    println("Favorito insertado: $inserted")
//                    assertEquals(pelicula1.id, inserted.idMovieEntity)
//                    assertEquals(pelicula1, inserted.pelicula)
//                }
//            )
//        }
//    }
